...
<img
  ...
  className="dark:invert opacity-85 w-2xs md:w-xs mx-auto py-4"
  width={200}
  height={200}
/>
...
2. Configuring its rules through our Issuer App.
3. Launching it directly on our secure Akemona domain using Admin App.
