...
[OnchainTA](https://OnchainTA.com) is one of the first **non-custodial transfer agents** designed specifically for digital asset securities. Unlike traditional transfer agents or custodial models, OnchainTA does not hold investor assets. Instead, investors retain ownership of their securities in their own wallets, while OnchainTA provides the regulatory, compliance, and operational functions required of a transfer agent.

<img
  src="/images/transfer-agent-onchainta.svg"
  className="w-2xs md:w-xs mx-auto"
  width={300}
  height={300}
/>
