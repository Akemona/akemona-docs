...
### 1. Digital Asset Offering Setup and Configuration
...
- **Consolidated Deal Terms**: Securely creates and centralizes deal information in a compliant format.
...
- **Investor Invitation**: Enable issuers to invite invite investors.
...
- **Automatic Document Generation**: Automatic generation of required offering documents.
